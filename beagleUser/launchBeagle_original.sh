...
echo -------------------------------------------------------
echo beagling original with mbr
echo -------------------------------------------------------
	...
	do
		...
		do
			...
			then
				...
				echo java -jar AMBeR.jar -p -b $BONUS -input1 $SET1 -input2 $SET2 -outfile $OUT 
				java -jar AMBeR.jar -p -b $BONUS -input1 $SET1 -input2 $SET2 -outfile $OUT 
